...
def dir_path(file_path):
    if os.path.isfile(file_path):
        ...
        raise argparse.ArgumentTypeError(
            f'Supplied argument "{file_path}" is not a valid file path.'
        )
...
parser.add_argument(
    "tag_file", type=dir_path, help="The path to the apriltag png you want to convert."
)
